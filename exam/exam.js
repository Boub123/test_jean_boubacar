...
const text = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas molestie in enim in ornare. Ut pellentesque vestibulum nunc eu mattis. Cras in tellus id dolor viverra hendrerit at vel diam. Duis luctus viverra molestie. Ut non eros ante. Nulla auctor accumsan erat, sed aliquam nunc aliquam eget. Aenean molestie aliquam libero, nec dapibus nisl maximus at. Vivamus eu odio ultricies, aliquet risus sit amet, aliquet lectus. Aliquam auctor odio at sapien varius consequat. Curabitur vel iaculis quam. Cras non nunc eleifend, sodales nulla ut, bibendum eros. Phasellus pharetra augue id scelerisque luctus. Mauris sit amet sem dapibus, iaculis velit at, porta turpis. Sed consectetur dictum euismod. In faucibus tincidunt nulla, sed faucibus lectus laoreet vel. Morbi luctus nisl id risus sollicitudin posuere. Proin vitae sapien quis tortor lobortis rhoncus ac in orci. Etiam id diam eu ex tincidunt consequat at non ex. Vestibulum gravida vel quam at eleifend. Vestibulum justo augue, semper vel mi non, tempor bibendum velit. Aenean porttitor tempor dolor eu tincidunt. Donec sed ipsum urna. Aliquam finibus nulla aliquet purus ornare rhoncus. Suspendisse potenti. Sed mi dolor, molestie ac sagittis id, accumsan ac orci. Nullam varius urna quis enim gravida egestas. Phasellus eget luctus ex. In accumsan elit elit, sed pellentesque leo auctor id. Duis mollis gravida enim in gravida. Nullam euismod sapien eu finibus rutrum. Morbi eget tortor efficitur, consectetur ligula vitae, interdum libero. Integer tempor fringilla placerat. Quisque id euismod turpis. Vestibulum cursus quam felis, sed dictum tellus sagittis maximus. Sed viverra condimentum nisi. Nullam rutrum tortor et metus ullamcorper, vel ultricies sapien feugiat. Duis tempor justo vitae turpis fringilla, a vulputate nibh imperdiet. Praesent at lectus dolor. Mauris vel sollicitudin tortor. Duis imperdiet magna dolor, vel semper mi condimentum at. Pellentesque in porta eros, sit amet faucibus arcu. Nullam viverra ex ut sem vehicula, sit amet imperdiet leo fringilla. Maecenas ligula enim, sodales ac viverra hendrerit, ornare ut lacus. Morbi ullamcorper risus et leo euismod, semper tempus elit scelerisque. Cras placerat erat augue, in scelerisque elit egestas et. Donec lacus eros, hendrerit eget tempus a, sodales ac arcu. Mauris suscipit nulla quis sem fringilla, ut mattis lectus consequat. Cras metus felis, tempor ut porttitor at, scelerisque a est. Morbi nisi elit, vestibulum a efficitur ut, varius ut risus. Mauris vel magna mauris. Curabitur vitae turpis libero. Praesent vitae sagittis diam. Mauris varius convallis nisl, et laoreet nunc.';
var searched = [];
// Ne rien modifier au dessus de ce commentaire

// Fonction qui retourne le plus petit element du tableau elements
function plusPetitElement(elements) {
	var result =Math.min(...elements);;
	// Ne rien modifier au dessus de ce commentaire
	
		console.log(Math.min(...elements));
...
// Fonction qui compte le nombre de "i" de la variable text
function compterText(text) {
	var result = 0;
	// Ne rien modifier au dessus de ce commentaire
...
document.getElementById('compterText').innerHTML = 'Le nombre de "i" est : ' + compterText(text);